...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        if ($customer->create($first_name, $last_name, $email, $phone_number, $address, $driver_license_number)) {
            $_SESSION['success'] = "เพิ่มข้อมูลลูกค้าเรียบร้อยแล้ว";
            header("Location: customers.php");
            exit();
        } else {
            $_SESSION['error'] = "ไม่สามารถเพิ่มข้อมูลลูกค้าได้";
        }
    } catch (Exception $e) {
...
<head>
    ...
    <title>ระบบจัดการรถยนต์ - เพิ่มลูกค้าใหม่</title>
